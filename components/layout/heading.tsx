...
const HEADING_CLASS = {
  1: "text-[1.875rem] leading-tight font-semibold tracking-tight md:text-[2.5rem] md:leading-[1.15]",
  2: "text-[1.75rem] leading-snug font-semibold tracking-tight md:text-[2rem]",
  3: "text-xl leading-snug font-semibold tracking-tight md:text-2xl",
} as const;

const TEXT_CLASS = {
  body: "text-[0.9375rem] leading-7 md:text-base",
  meta: "text-[0.8125rem] leading-5 md:text-sm",
  muted: "text-[0.9375rem] leading-7 text-muted-foreground md:text-base",
} as const;
